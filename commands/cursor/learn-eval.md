...
3. **Determine save location:**
   ...
   - **User-level** (`<HOME>/.cursor/skills/learned/`): Generic patterns usable across 2+ projects (bash compatibility, LLM API behavior, debugging techniques, etc.)
   - **Project-level** (`<REPO>/.cursor/skills/learned/`): Project-specific knowledge (quirks of a particular config file, project-specific architecture decisions, etc.)
   - When in doubt, choose user-level (moving user-level → project-level is easier than the reverse)
