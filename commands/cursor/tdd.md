...
This command invokes the `tdd-guide` subagent (Cursor).

Agent install location can vary by environment:
- Project-local (preferred when present): `<REPO>/.cursor/agents/tdd-guide.md`
- Global (personal): `<HOME>/.cursor/agents/tdd-guide.md`
